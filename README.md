...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/aniruddhakasar/Movie-Recommender-System/blob/main/requirements.txt) file with the command `pip install -r requirements.txt`
4. Open your terminal/command prompt from your project directory and run the file `main.py` by executing the command `streamlit run app.py`.
